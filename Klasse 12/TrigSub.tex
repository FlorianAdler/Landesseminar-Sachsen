...
\begin{enumerate}[label={$(\alph*)$},ref={$(\alph*)$}]\itshape
	...
	\item Wenn $x$, $y$ und $z$ nichtnegative reelle Zahlen mit $x^2+y^2+z^2+2xyz=1$ sind, dann können wir auch $x=\sin\parens[\big]{\frac{\alpha}2}$, $y=\sin\parens[\big]{\frac{\beta}2}$ und $z=\sin\parens[\big]{\frac{\gamma}2}$ substituieren, wobei $\alpha$, $\beta$ und $\gamma$ die Innenwinkel eines Dreiecks sind \embrace{dieses Dreiecks muss aber nicht spitz- oder rechtwinklig sein}.
\end{enumerate}
Damit könnt ihr nun die folgenden beiden Aufgaben lösen, die ohne dieses Wissen sehr schwierig wären.%Aufgabe~\ref{aufgabe:UngleichungInvertieren2} ist euch bereits im Kapitel \emph{Die $uvw$-Methode} im Heft für Klasse~11 begegnet. Die Musterlösung zu dieser Aufgabe war ein ziemlichen Holzhammer-Beweis. Hier seht ihr nun, wie sie sich wesentlich eleganter lösen lässt.
