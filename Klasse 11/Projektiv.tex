...
\begin{proof}
	Es lässt sich leicht nachprüfen, dass $(A,B;C,D)$ und $(PA,PB;PC,PD)$ das gleiche Vorzeichen haben. Wir müssen also nur prüfen, dass auch ihre Beträge übereinstimmen.
	...
	\begin{align*}
		\frac{\abs{AC}}{\abs{CB}}\bigg/\frac{\abs{AD}}{\abs{DB}}&=\frac{\abs{PA}\cdot\sin\winkel(PA,PC)}{\abs{PB}\cdot \sin\winkel(PC,PB)}\bigg/\frac{\abs{PA}\cdot\sin\winkel(PA,PD)}{\abs{PB}\cdot \sin\winkel(PD,PB)}\\
		&=\frac{\sin\winkel(PA,PC)}{\sin\winkel(PC,PB)}\bigg/\frac{\sin\winkel(PA,PD)}{\sin\winkel(PD,PB)}\,,
	\end{align*}
...
\begin{proof}
	...
	\begin{figure}[ht]
		...
		\begin{tabularx}{\textwidth}{X c X c X}
			& \begin{tikzpicture}[x=0.65cm,y=0.65cm]
				\clip (-0.25,-1.45) rectangle (7.5,4.42);
			...
			\end{tikzpicture} & & \begin{tikzpicture}[x=0.52cm,y=0.52cm]
				\clip (-0.25,-1.9) rectangle (9.3,5.65);
	...
	\begin{figure}[ht]
		...
		\begin{tabularx}{\textwidth}{X c X c X}
			& \begin{tikzpicture}[x=0.6cm,y=0.6cm]
				\clip (-1.25,-2.1) rectangle (5.18,4.62);
...
\begin{figure}[ht]
	...
	\begin{tikzpicture}[x=2.35cm,y=2.35cm]
		\clip (-0.4,-0.42) rectangle (1.5,1.3);
		...
		\draw[shorten <=-3ex,shorten >=-5.9ex] (Q) to (P1);
		\draw[shorten <=-13.75ex,shorten >=-7ex] (Q1) to (P);
...
\begin{figure}[ht]
	...
	\begin{tikzpicture}[x=1.65cm,y=1.65cm]
		\clip (-2.45,-1.28) rectangle (1.1,1.35);
		%\draw[line width=0.3] (-22:1) arc (-22:110:1);
...
\begin{figure}[ht]
	...
	\begin{tikzpicture}[x=1.25cm,y=1.25cm]
		\clip (-3.01,-1.75) rectangle (3.46,3.4);
		%\draw[line width=0.3] (-22:1) arc (-22:110:1);
...
\begin{figure}[ht]
	\centering
	\begin{tikzpicture}[x=1.65cm,y=1.65cm]
		\clip (-2.45,-1.2) rectangle (1.1,1.2);
		%\draw[line width=0.3] (-22:1) arc (-22:110:1);
		\draw [line width=0.3] (0,0) circle (1);
		\coordinate (A) at (-0.387,0.922);
		\coordinate (B) at (-0.533,-0.846);
...
\begin{figure}[ht]
	\centering
	\begin{tikzpicture}[x=0.8cm,y=0.8cm]
		\clip (-4.8,-0.75) rectangle (8.1,7.6);
