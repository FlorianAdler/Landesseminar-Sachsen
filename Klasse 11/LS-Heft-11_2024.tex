...
\begin{document}
	...
	\begin{center}\Huge
		\textbf{Begleitmaterial zum Seminarprogramm \\ der Klassenstufe 11}
	\end{center}
	...
	\input{LCF_Loesungen}
	\input{uvw_Loesungen}
	\input{GraphenInCombo_Loesungen}
	\input{Pell_Loesungen}
	\input{Galois_Loesungen}
