...
\begin{document}
	...
	\begin{center}\Huge
		\textbf{Begleitmaterial zum Seminarprogramm \\ der Klassenstufe 9}
	\end{center}
	...
	%\addcontentsline{toc}{part}{Geometrie}
	
	
	
	\newpage\cftaddtitleline{toc}{part}{Gleichungen und Ungleichungen}{\thepage}
	\input{Gleichungssysteme}\newpage
	\input{Mittelungleichungen}\newpage
	\input{Umordnung}\newpage
	\input{Schieben}\newpage
	...
	\input{Gleichungssysteme_Loesungen}
	\input{Umordnung_Loesungen}
	\input{Inversion_Loesungen}
	\input{Graphentheorie_Loesungen}
	\input{Algorithmen_Loesungen}
	\input{Diophantisch_Loesungen}
	\input{Quersummen_Loesungen}
